...
# Button 6.
button6 = Button(frame, text = 5, height = 4, width = 9, font = 35, command = lambda: button_press(6))
button6.grid(row = 1, column = 1)

# Button 7.
button7 = Button(frame, text = 6, height = 4, width = 9, font = 35, command = lambda: button_press(7))
...
# Button 10.
button10 = Button(frame, text = 8, height = 4, width = 9, font = 35, command = lambda: button_press(10))
button10.grid(row = 2, column = 1)

# Button 11.
button11 = Button(frame, text = 9, height = 4, width = 9, font = 35, command = lambda: button_press(11))
...
# Button 16.
divide = Button(frame, text = "/", height = 4, width = 9, font = 35, command = button_press("/"))
